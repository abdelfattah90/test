...
import '../context/section72text.dart';

class Section72 extends StatefulWidget {
  const Section72({super.key});

  @override
  State<Section72> createState() => _Section72State();
}

class _Section72State extends State<Section72> {
