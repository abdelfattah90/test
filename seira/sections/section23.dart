...
import '../context/section23text.dart';

class Section23 extends StatefulWidget {
  const Section23({super.key});

  @override
  State<Section23> createState() => _Section23State();
}

class _Section23State extends State<Section23> {
