...
import '../context/section20text.dart';

class Section20 extends StatefulWidget {
  const Section20({super.key});

  @override
  State<Section20> createState() => _Section20State();
}

class _Section20State extends State<Section20> {
