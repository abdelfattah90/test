...
import '../context/section76text.dart';

class Section76 extends StatefulWidget {
  const Section76({super.key});

  @override
  State<Section76> createState() => _Section76State();
}

class _Section76State extends State<Section76> {
