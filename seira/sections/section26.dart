...
import '../context/section26text.dart';

class Section26 extends StatefulWidget {
  const Section26({super.key});

  @override
  State<Section26> createState() => _Section26State();
}

class _Section26State extends State<Section26> {
