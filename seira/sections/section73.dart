...
import '../context/section73text.dart';

class Section73 extends StatefulWidget {
  const Section73({super.key});

  @override
  State<Section73> createState() => _Section73State();
}

class _Section73State extends State<Section73> {
