...
import '../context/section25text.dart';

class Section25 extends StatefulWidget {
  const Section25({super.key});

  @override
  State<Section25> createState() => _Section25State();
}

class _Section25State extends State<Section25> {
