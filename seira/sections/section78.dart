...
import '../context/section78text.dart';

class Section78 extends StatefulWidget {
  const Section78({super.key});

  @override
  State<Section78> createState() => _Section78State();
}

class _Section78State extends State<Section78> {
