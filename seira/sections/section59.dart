...
import '../context/section59text.dart';

class Section59 extends StatefulWidget {
  const Section59({super.key});

  @override
  State<Section59> createState() => _Section59State();
}

class _Section59State extends State<Section59> {
