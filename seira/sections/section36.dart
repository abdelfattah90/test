...
import '../context/section36text.dart';

class Section36 extends StatefulWidget {
  const Section36({super.key});

  @override
  State<Section36> createState() => _Section36State();
}

class _Section36State extends State<Section36> {
