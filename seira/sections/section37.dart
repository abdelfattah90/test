...
import '../context/section37text.dart';

class Section37 extends StatefulWidget {
  const Section37({super.key});

  @override
  State<Section37> createState() => _Section37State();
}

class _Section37State extends State<Section37> {
