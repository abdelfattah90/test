...
import '../context/section42text.dart';

class Section42 extends StatefulWidget {
  const Section42({super.key});

  @override
  State<Section42> createState() => _Section42State();
}

class _Section42State extends State<Section42> {
