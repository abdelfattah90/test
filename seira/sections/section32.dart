...
import '../context/section32text.dart';

class Section32 extends StatefulWidget {
  const Section32({super.key});

  @override
  State<Section32> createState() => _Section32State();
}

class _Section32State extends State<Section32> {
