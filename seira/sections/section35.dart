...
import '../context/section35text.dart';

class Section35 extends StatefulWidget {
  const Section35({super.key});

  @override
  State<Section35> createState() => _Section35State();
}

class _Section35State extends State<Section35> {
