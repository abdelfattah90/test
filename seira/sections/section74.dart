...
import '../context/section74text.dart';

class Section74 extends StatefulWidget {
  const Section74({super.key});

  @override
  State<Section74> createState() => _Section74State();
}

class _Section74State extends State<Section74> {
