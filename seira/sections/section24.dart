...
import '../context/section24text.dart';

class Section24 extends StatefulWidget {
  const Section24({super.key});

  @override
  State<Section24> createState() => _Section24State();
}

class _Section24State extends State<Section24> {
