...
import '../context/section47text.dart';

class Section47 extends StatefulWidget {
  const Section47({super.key});

  @override
  State<Section47> createState() => _Section47State();
}

class _Section47State extends State<Section47> {
