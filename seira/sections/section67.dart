...
import '../context/section67text.dart';

class Section67 extends StatefulWidget {
  const Section67({super.key});

  @override
  State<Section67> createState() => _Section67State();
}

class _Section67State extends State<Section67> {
