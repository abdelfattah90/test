...
import '../context/section70text.dart';

class Section70 extends StatefulWidget {
  const Section70({super.key});

  @override
  State<Section70> createState() => _Section70State();
}

class _Section70State extends State<Section70> {
