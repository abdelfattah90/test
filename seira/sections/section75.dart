...
import '../context/section75text.dart';

class Section75 extends StatefulWidget {
  const Section75({super.key});

  @override
  State<Section75> createState() => _Section75State();
}

class _Section75State extends State<Section75> {
