...
import '../context/section50text.dart';

class Section50 extends StatefulWidget {
  const Section50({super.key});

  @override
  State<Section50> createState() => _Section50State();
}

class _Section50State extends State<Section50> {
