...
import '../context/section71text.dart';

class Section71 extends StatefulWidget {
  const Section71({super.key});

  @override
  State<Section71> createState() => _Section71State();
}

class _Section71State extends State<Section71> {
