...
import '../context/section31text.dart';

class Section31 extends StatefulWidget {
  const Section31({super.key});

  @override
  State<Section31> createState() => _Section31State();
}

class _Section31State extends State<Section31> {
