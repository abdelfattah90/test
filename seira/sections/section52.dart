...
import '../context/section52text.dart';

class Section52 extends StatefulWidget {
  const Section52({super.key});

  @override
  State<Section52> createState() => _Section52State();
}

class _Section52State extends State<Section52> {
