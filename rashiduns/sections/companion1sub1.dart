...
import '../context/companion1textsub1.dart';

class Companion1sub1 extends StatefulWidget {
  const Companion1sub1({super.key});

  @override
  State<Companion1sub1> createState() => _Companion1sub1State();
}

class _Companion1sub1State extends State<Companion1sub1> {
          ...
          bodyContant(
            [
              ...
              createParagraph(
                  ...
                  isDarkMode: _preferencesManager.isDarkMode),
              createParagraph(
                  paragraphTitle(t1[0], t5[1], sectionIndex,
                      isCompanion: true,
                      isDarkMode: _preferencesManager.isDarkMode),
                  [
                    paragraphContent(p8,
