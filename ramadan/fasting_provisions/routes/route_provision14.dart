...
class RouteProvision14 extends StatelessWidget {
  const RouteProvision14({
    super.key,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, 'provision14');
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Image.asset(
              'assets/images/ramadan/nawafel.png',
              width: 30,
              height: 30,
            ),
            Text(
              'صيام النوافل والقضاء',
              style: TextStyle(
                fontFamily: 'swissr',
                fontSize: 12,
